...
import XMLAComposer from "@/plugins/charts/widgets/parts/XMLAComposer.vue";
    ...
    <div class="settings-container">
     ...
     <div class="composers" v-for="(composer, i) in component.settings.composer">
            ...
            <template v-if="composer instanceof XMLAComposer">
                <XMLAComposerV :modelValue="component.settings.composer[i]" :axes="component.settings.axes":component="component"></XMLAComposerV>
            </template>
      </div>
