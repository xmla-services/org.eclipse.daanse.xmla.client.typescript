...
const props = defineProps(["rootHierarchy", "datasource"]);
        ...
        <div class="mb-3" style="overflow: auto; height: 100%">
            ...
            >
                <template #content="node">
                    ...
                    >
                        <template
                            v-if="multipleChoise && !node.partiallySelected"
                        >
                            <va-checkbox
                                class="mr-2"
                                :model-value="node.selected"
                                @click.stop.prevent="
                                    treeData.changeSelection(node)
                                "
                            />
                        </template>
                        <template
                            v-else-if="multipleChoise && node.partiallySelected"
                        >
                            <va-checkbox
                                class="mr-2"
                                :model-value="true"
